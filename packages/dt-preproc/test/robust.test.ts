...
function projectRows(rows: readonly LogRowWithFeats[]): Array<Record<string, unknown>> {
  return rows.map((row) => ({
    ...
    delta_quantiles: row.delta_quantiles,
    delta_m25: row.delta_m25,
    delta_m50: row.delta_m50,
    delta_m75: row.delta_m75,
    ...
    assert.deepEqual(
      {
        ...
        delta_quantiles: a.delta_quantiles,
        delta_m25: a.delta_m25,
        delta_m50: a.delta_m50,
        delta_m75: a.delta_m75,
      ...
      },
      {
        ...
        delta_quantiles: b.delta_quantiles,
        delta_m25: b.delta_m25,
        delta_m50: b.delta_m50,
        delta_m75: b.delta_m75,
